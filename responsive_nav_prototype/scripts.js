...
function panelToggle() {
	...
	var navPanel = document.getElementById("navColumn");
	...
	if (dashboardPanel.className === "expandedPanel") {
		...
		navPanel.className = "collapsedNav"
		buttons.className = "panelToggleRight";
		navOverlay.style.opacity = "0";
		headerText.className = "stretchedContent h1";
		content.className = "stretchedContent";
    } else {
        dashboardPanel.className = "expandedPanel";
		navPanel.className = "expandedNav"
		buttons.className = "panelToggleLeft";
		headerText.className = "compressedContent h1";
		navOverlay.style.opacity = "1";
		content.className = "compressedContent";
    }
}
...
function arrowHover(){
	var toggleArrow = document.getElementById("toggle_arrow");
	var whiteHamburgerSVG = document.getElementById("whiteHamburgerSVG");
	toggleArrow.style.stroke = "#75C4FF";
	whiteHamburgerSVG.style.fill = "#75C4FF";
}
function arrowOut(){
	var toggleArrow = document.getElementById("toggle_arrow");
	var whiteHamburgerSVG = document.getElementById("whiteHamburgerSVG");
	toggleArrow.style.stroke = "#FFFFFF";
	whiteHamburgerSVG.style.fill = "#FFFFFF";
}
...
function hamburgerHover(){
	var blackHamburgerSVGIcon = document.getElementById("blackHamburgerSVG");
	blackHamburgerSVG.style.fill = "#026AF3";
}
function hamburgerOut(){
	var blackHamburgerSVG = document.getElementById("blackHamburgerSVG");
	blackHamburgerSVG.style.fill = "#222222";
}